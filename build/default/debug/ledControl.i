...
void safetyLed(void) {
    ...
    if (closeSafety1.resistive_status && closeSafety2.resistive_status ) {
        do { TRISFbits.TRISF0 = 0; } while(0);
        do { LATFbits.LATF0 = ~LATFbits.LATF0; } while(0);
        ...
        do { TRISFbits.TRISF0 = 1; } while(0);
    }


    if (openSafety1.resistive_status && openSafety2.resistive_status ) {
        do { TRISFbits.TRISF1 = 0; } while(0);
        do { LATFbits.LATF1 = ~LATFbits.LATF1; } while(0);
