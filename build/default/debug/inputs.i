...
void commandFilter(_Bool getInput, struct command *commandName) {
...
void inputs() {
    commandFilter(PORTCbits.RC2, &cmdOpen);
    commandFilter(PORTCbits.RC5, &cmdClose);
    commandFilter(PORTCbits.RC3, &cmdReverse);
    commandFilter(PORTCbits.RC7, &cmdAuxOpen);
    commandFilter(PORTAbits.RA6, &cmdStopPb);
    commandFilter(PORTCbits.RC4, &cmdStopSw);
    commandFilter(PORTCbits.RC6, &cmdSingle);

    commandFilter(PORTBbits.RB1, &openLimit);
    commandFilter(PORTBbits.RB0, &closeLimit);
}
