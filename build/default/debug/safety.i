...
void closeSafety_check(){
    resistive_safetyCheck(ADC_ChannelSelectAndConvert(ADC_CHANNEL_ANA4),&closeSafety1);

    resistive_safetyCheck(ADC_ChannelSelectAndConvert(ADC_CHANNEL_ANA5),&closeSafety2);
...
void openSafety_check(){
    resistive_safetyCheck(ADC_ChannelSelectAndConvert(ADC_CHANNEL_ANG6),&openSafety1);

    resistive_safetyCheck(ADC_ChannelSelectAndConvert(ADC_CHANNEL_ANA2),&openSafety2);
