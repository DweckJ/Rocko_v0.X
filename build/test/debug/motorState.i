...
uint16_t currentDutyCycle = 15;
uint16_t stepSize = 1;
uint16_t stepSizeC = 5;
uint16_t topSpeed = 250;
uint16_t rampstep = 0;
float dutyAccumulator = 0.0;
